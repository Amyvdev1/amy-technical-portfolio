    ...
    <div className="lab-shell nocturne-lab">
      ...
      <main className="lab-main">
        ...
        <section className="lab-principles">
          <div className="portrait-panel"><img src="https://raw.githubusercontent.com/Amyvdev1/amy-technical-portfolio/main/public-assets/amy-operator-portrait.png" alt="Amy Villa" /><div className="portrait-tag"><span>AMY VILLA</span><small>BUILDING FOR CLARITY</small></div></div>
